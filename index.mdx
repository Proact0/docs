...
**Week one**: a single graph and a working demo.

**Week four**: responsibilities blur, tests are brittle, and no one is sure where the next change belongs.

Act Operator is a **CLI and project standard** that keeps that drift from happening.
It makes Acts and Casts explicit, and it provides AI Skills that keep architecture, development,
